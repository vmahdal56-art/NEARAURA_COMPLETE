...
class IntentActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        binding.cardDating.setOnClickListener { saveIntent(UserIntent.DATING) }
        binding.cardFriends.setOnClickListener { saveIntent(UserIntent.FRIENDS) }
        binding.cardCommunity.setOnClickListener { saveIntent(UserIntent.COMMUNITY) }
    }
