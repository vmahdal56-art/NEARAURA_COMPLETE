...
class ProfileFragment : Fragment() {
    ...
    private fun updateIntentSelection(intent: String) {
        when (intent) {
            UserIntent.DATING -> binding.chipDating.isChecked = true
            UserIntent.FRIENDS -> binding.chipFriends.isChecked = true
            UserIntent.COMMUNITY -> binding.chipCommunity.isChecked = true
        }
    }
    ...
    private fun setupListeners() {
        ...
        binding.intentChipGroup.setOnCheckedChangeListener { _, checkedId ->
            val intent = when (checkedId) {
                R.id.chip_dating -> UserIntent.DATING
                R.id.chip_friends -> UserIntent.FRIENDS
                R.id.chip_community -> UserIntent.COMMUNITY
